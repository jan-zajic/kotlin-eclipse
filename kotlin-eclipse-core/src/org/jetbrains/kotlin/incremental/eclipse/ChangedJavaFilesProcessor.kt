...
import org.jetbrains.kotlin.core.compiler.EclipseICReporter
...
internal class ChangedJavaFilesProcessor(private val reporter: ICReporter) {
    ...
    private final val javaLang = JavaLanguage.INSTANCE
	private final val eclipseReporter = reporter as EclipseICReporter
	private final val ktProject =  KotlinEnvironment.getEnvironment(eclipseReporter.project).project
	private final val psiFileFactory = PsiFileFactory.getInstance(ktProject)
